...
export const channelDetailsSchema = z.object({
  chat: z.object({
    facebookMessenger: z.object({
      ...
      hasAdminAccess: z.enum(['yes', 'no', 'undecided'], { invalid_type_error: 'Vui lòng chọn một tuỳ chọn', required_error: 'Vui lòng chọn một tuỳ chọn' }).optional(),
    }).optional(),
    instagram: z.object({
      accountName: z.string().optional(),
      accountLink: z.string().optional(),
      linkedToFacebook: z.enum(['yes', 'no', 'undecided'], { invalid_type_error: 'Vui lòng chọn một tuỳ chọn', required_error: 'Vui lòng chọn một tuỳ chọn' }).optional(),
  ...
  sales: z.object({
    ...
    ecommerceWebsite: z.object({
      domain: z.string().optional(),
      platform: z.string().optional(),
      hasApi: z.enum(['yes', 'no', 'undecided'], { invalid_type_error: 'Vui lòng chọn một tuỳ chọn', required_error: 'Vui lòng chọn một tuỳ chọn' }).optional(),
      adminName: z.string().optional(),
    }).optional(),
    pos: z.object({
