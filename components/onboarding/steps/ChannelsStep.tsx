...
export const ChannelsStep: React.FC = () => {
  ...
  return (
    <div className="animate-in fade-in slide-in-from-right-4 duration-300">
      <h2 className="text-lg md:text-xl font-semibold text-foreground mb-1 md:mb-2">Chọn các kênh cần tích hợp <span className="text-sm font-normal text-slate-500">(Không bắt buộc)</span></h2>
      <p className="text-sm md:text-base text-text-muted mb-4 md:mb-6">Bạn có thể chọn nhiều nền tảng thuộc các nhóm khác nhau, hoặc để trống và cung cấp sau.</p>
