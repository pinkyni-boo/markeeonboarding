      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center w-full mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 w-full text-left">
          ...
          <div className="bg-white hover:bg-slate-50 border border-border-color p-4 md:p-6 rounded-[20px] shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 flex flex-row md:flex-col items-start gap-4 md:gap-0 relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-32 h-32 bg-primary/[0.04] rounded-bl-full transition-transform group-hover:scale-110" />
            <div className="shrink-0 w-14 h-14 bg-primary/10 rounded-[16px] flex items-center justify-center md:mb-5 border border-primary/20 relative z-10 group-hover:bg-primary/15 transition-colors">
              <Clock className="w-7 h-7 text-primary" strokeWidth={2.5} />
            </div>
            <div>
              <h4 className="font-bold text-foreground text-base md:text-lg mb-1 md:mb-2 relative z-10">Thời gian nhanh chóng</h4>
          ...
          <div className="bg-white hover:bg-slate-50 border border-border-color p-4 md:p-6 rounded-[20px] shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 flex flex-row md:flex-col items-start gap-4 md:gap-0 relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-32 h-32 bg-primary/[0.04] rounded-bl-full transition-transform group-hover:scale-110" />
            <div className="shrink-0 w-14 h-14 bg-primary/10 rounded-[16px] flex items-center justify-center md:mb-5 border border-primary/20 relative z-10 group-hover:bg-primary/15 transition-colors">
              <Edit3 className="w-7 h-7 text-primary" strokeWidth={2.5} />
            </div>
            <div>
              <h4 className="font-bold text-foreground text-base md:text-lg mb-1 md:mb-2 relative z-10">Dễ dàng chỉnh sửa</h4>
          ...
          <div className="bg-white hover:bg-slate-50 border border-border-color p-4 md:p-6 rounded-[20px] shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 flex flex-row md:flex-col items-start gap-4 md:gap-0 relative overflow-hidden group">
            ...
            <div>
              <h4 className="font-bold text-foreground text-base md:text-lg mb-1 md:mb-2 relative z-10">Bảo mật thông tin</h4>
